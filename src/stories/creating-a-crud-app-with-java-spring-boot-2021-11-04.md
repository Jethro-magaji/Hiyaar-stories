...
shortDesc: Java is a multi-platform, object-oriented, and network-centric
  language with a lot of framework to make software development easy, one  these
  frameworks is Spring Boot.   Spring Boot is an open-source Java-based
  framework used to create a microservice. It provides a good platform for Java
  developers to develop stand-alone and production-grade spring applications.
badge: "Technology "
...
### Introduction
 ...
 Spring Boot is an open-source Java-based framework used to create a microservice. It provides a good platform for Java developers to develop stand-alone and production-grade spring applications.
